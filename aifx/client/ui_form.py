...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.hl_latency = QHBoxLayout()
        self.hl_latency.setObjectName(u"hl_latency")
        self.wgt_plot_brain_latency = QWidget(Widget)
        self.wgt_plot_brain_latency.setObjectName(u"wgt_plot_brain_latency")

        self.hl_latency.addWidget(self.wgt_plot_brain_latency)
        ...
        self.hl_latency.addWidget(self.wgt_plot_broker_latency)
        ...
        self.hl_latency.addWidget(self.wgt_plot_oanda_latency)


        self.verticalLayout.addLayout(self.hl_latency)
