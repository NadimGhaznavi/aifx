...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        self.wgt_candle_plot = QWidget(Widget)
        self.wgt_candle_plot.setObjectName(u"wgt_candle_plot")

        self.vl_instrument.addWidget(self.wgt_candle_plot)

        self.vl_instrument.setStretch(2, 1)

        self.verticalLayout.addLayout(self.vl_instrument)

        self.hl_latency_plots = QHBoxLayout()
        self.hl_latency_plots.setObjectName(u"hl_latency_plots")
        self.wgt_plot_broker_latency = QWidget(Widget)
        self.wgt_plot_broker_latency.setObjectName(u"wgt_plot_broker_latency")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.wgt_plot_broker_latency.sizePolicy().hasHeightForWidth())
        self.wgt_plot_broker_latency.setSizePolicy(sizePolicy1)
        self.wgt_plot_broker_latency.setMinimumSize(QSize(0, 150))

        self.hl_latency_plots.addWidget(self.wgt_plot_broker_latency)

        self.wgt_plot_oanda_latency = QWidget(Widget)
        self.wgt_plot_oanda_latency.setObjectName(u"wgt_plot_oanda_latency")
        sizePolicy1.setHeightForWidth(self.wgt_plot_oanda_latency.sizePolicy().hasHeightForWidth())
        self.wgt_plot_oanda_latency.setSizePolicy(sizePolicy1)
        self.wgt_plot_oanda_latency.setMinimumSize(QSize(0, 150))

        self.hl_latency_plots.addWidget(self.wgt_plot_oanda_latency)


        self.verticalLayout.addLayout(self.hl_latency_plots)

        self.horizontalLayout_2 = QHBoxLayout()
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.hl_broker_status = QHBoxLayout()
        self.hl_broker_status.setObjectName(u"hl_broker_status")
        ...
        self.hl_broker_status.addWidget(self.lbl_broker)
        ...
        sizePolicy2.setHeightForWidth(self.lbl_broker_status.sizePolicy().hasHeightForWidth())
        self.lbl_broker_status.setSizePolicy(sizePolicy2)
        self.lbl_broker_status.setFont(font2)
        self.lbl_broker_status.setAlignment(Qt.AlignBottom|Qt.AlignRight|Qt.AlignTrailing)

        self.hl_broker_status.addWidget(self.lbl_broker_status)


        self.horizontalLayout_2.addLayout(self.hl_broker_status)

        self.horizontalSpacer_2 = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)

        self.horizontalLayout_2.addItem(self.horizontalSpacer_2)

        self.hl_oanda_status = QHBoxLayout()
        self.hl_oanda_status.setObjectName(u"hl_oanda_status")
        ...
        self.hl_oanda_status.addWidget(self.lbl_oanda)
        ...
        self.hl_oanda_status.addWidget(self.lbl_oanda_status)


        self.horizontalLayout_2.addLayout(self.hl_oanda_status)
        ...
        sizePolicy3.setHeightForWidth(self.lbl_instrument.sizePolicy().hasHeightForWidth())
        self.lbl_instrument.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.cb_instrument.sizePolicy().hasHeightForWidth())
        self.cb_instrument.setSizePolicy(sizePolicy4)
